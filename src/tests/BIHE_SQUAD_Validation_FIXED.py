...
Versão Corrigida - ImportError scipy.spatial.distance.cosine_distances
Status: Fixed para scipy >= 1.13
...
from sklearn.metrics.pairwise import cosine_similarity  # ✅ CORRETO
...
def validate_squad():
    ...
    print("\n" + "=" * 80)
    print("SQUAD VALIDATION - BIHE Quantization (FIXED)")
    print("=" * 80)
...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("\nMudança na linha 13:")
    print("  ❌ from scipy.spatial.distance import cosine_distances")
    print("  ✅ from sklearn.metrics.pairwise import cosine_similarity")
    print("\nMudança no código:")
    print("  ❌ cosine_distances([original[i]], original)")
    print("  ✅ cosine_similarity([original[i]], original)")
